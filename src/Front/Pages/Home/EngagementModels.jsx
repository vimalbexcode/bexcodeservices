                ...
                <div className="flex flex-col gap-10 ">
                    ...
                    <div className="flex flex-col w-full max-w-[800px] md:flex-row mx-auto md:items-center justify-center gap-8 md:gap-10">
                        ...
                        <div className="flex-1">
                            <h3 className="font-['Plus_Jakarta_Sans'] text-black font-medium text-[16px] sm:text-[18px] lg:text-[20px] leading-tight mb-3">
                                Dedicated resource
                            </h3>

                            <p className="font-['Plus_Jakarta_Sans'] text-[#45556C] text-[13px] sm:text-[14px] lg:text-[16px] leading-[1.6]">
